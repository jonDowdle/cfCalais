...
For param definitions see:

http://opencalais.com/documentation/calais-web-service-api/forming-api-calls/input-parameters
...
<cfscript>
licKey = "d4tadskdh5vzuj45r73r8zd6";
enlightenWS = createObject('webservice', 'http://api.opencalais.com/enlighten/?wsdl');
rdf = enlightenWS.enlighten(licKey, content, params);
</cfscript>

<cfif isJson(rdf)>
	<cfdump var="#DeserializeJSON(rdf)#">
<cfelseif isXml(rdf)>
	<cfdump var="#xmlParse(rdf)#">	
</cfif>